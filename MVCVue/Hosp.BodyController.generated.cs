...
namespace MVCVue.Areas.Hosp.Controllers
{
    public partial class BodyController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected BodyController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public BodyController Actions { get { return MVC.Hosp.Body; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Hosp";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Body";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Body";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string API = "~/Areas/Hosp/Views/Body/API.cshtml";
            public readonly string Index = "~/Areas/Hosp/Views/Body/Index.cshtml";
            public readonly string template = "~/Areas/Hosp/Views/Body/template.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BodyController : MVCVue.Areas.Hosp.Controllers.BodyController
    {
        public T4MVC_BodyController() : base(Dummy.Instance) { }
