...
namespace MVCVue.Areas.Hosp.Controllers
{
    public partial class FormController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FormController Actions { get { return MVC.Hosp.Form; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string API = "~/Areas/Hosp/Views/Form/API.cshtml";
            public readonly string Index = "~/Areas/Hosp/Views/Form/Index.cshtml";
            public readonly string template = "~/Areas/Hosp/Views/Form/template.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FormController : MVCVue.Areas.Hosp.Controllers.FormController
    {
