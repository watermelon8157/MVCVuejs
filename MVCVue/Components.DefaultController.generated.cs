...
namespace MVCVue.Areas.Components.Controllers
{
    public partial class DefaultController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public DefaultController Actions { get { return MVC.Components.Default; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Components";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string API = "~/Areas/Components/Views/Default/API.cshtml";
            public readonly string Index = "~/Areas/Components/Views/Default/Index.cshtml";
            public readonly string template = "~/Areas/Components/Views/Default/template.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_DefaultController : MVCVue.Areas.Components.Controllers.DefaultController
    {
