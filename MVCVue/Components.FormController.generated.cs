...
namespace MVCVue.Areas.Components.Controllers
{
    public partial class FormController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public FormController Actions { get { return MVC.Components.Form; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string API = "~/Areas/Components/Views/Form/API.cshtml";
            public readonly string Index = "~/Areas/Components/Views/Form/Index.cshtml";
            public readonly string template = "~/Areas/Components/Views/Form/template.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_FormController : MVCVue.Areas.Components.Controllers.FormController
    {
